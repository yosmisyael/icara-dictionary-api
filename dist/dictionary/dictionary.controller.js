...
let DictionaryController = class DictionaryController {
    ...
    async getDictionaryList() {
        const data = await this.dictionaryService.getAllEntries();
        return { data };
    }
...
], DictionaryController.prototype, "getDictionaryList", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    ...
    __metadata("design:returntype", Promise)
], DictionaryController.prototype, "getDictionaryEntryById", null);
exports.DictionaryController = DictionaryController = __decorate([
    (0, common_1.Controller)('api/dictionary'),
